...
def test_invalidusername(test_setup):
    ...
    driver.find_element_by_xpath("//input[@name='username']").send_keys('dineshkumar')
...
def test_invalidpassword(test_setup):
    driver.find_element_by_xpath("//button[@class='button button1']").click()
    driver.find_element_by_xpath("//input[@name='username']").send_keys('dinesh')
    driver.find_element_by_xpath("//input[@name='password']").send_keys('notdinesh')
    driver.find_element_by_xpath("//input[@type='submit']").click()
    assert driver.title == 'Login!'
