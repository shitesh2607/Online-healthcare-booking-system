...
class DoctorSignUpForm(UserCreationForm):
    ...
    phone_number = forms.CharField(required=True,validators=[number],max_length=10,min_length=10, widget=forms.TextInput({'pattern':'[6-9]{1}[0-9]{9}', 'title':'Invalid Mobile Number'}))
